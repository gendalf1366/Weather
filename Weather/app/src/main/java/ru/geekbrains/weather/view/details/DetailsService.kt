...
class DetailsService(name: String = "DetailService") : IntentService(name) {
    ...
    private fun onResponse(weatherDTO: WeatherDTO) {
        ...
        if (fact == null) {
            ...
            onSuccessResponse(fact.temp, fact.feels_like, fact.condition, fact.humidity)
        }
    }

    private fun onSuccessResponse(temp: Int?, feelsLike: String?, condition: String?, humidity: Int?) {
